plugins {
    ...
    id("com.vanniktech.maven.publish") version "0.30.0" // controlla se esiste una versione più recente
}
...
mavenPublishing {
    ...
    pom {
        ...
        url.set("https://github.com/<org>/daasiot-android") // TODO: metti l'URL reale del repo
        ...
        developers {
            developer {
                id.set("sebyone")   // TODO
                name.set("Sebyone Srl")     // TODO
                organization.set("Sebyone")
            }
        }
        scm {
            url.set("https://github.com/sebyone/daasiot-android") // TODO
            connection.set("scm:git:https://github.com/sebyone/daasiot-android.git") // TODO
            developerConnection.set("scm:git:ssh://git@github.com/sebyone/daasiot-android.git") // TODO
        }
    }
}
